<template>
  <div class="home-container">
    ...
    <nav class="navbar">
      ...
      <div class="nav-links">
        <button class="nav-link" @click="$emit('navigate', '/login')">
    ...
    <main class="home-content">
      <section class="hero">
        ...
        <div class="hero-buttons">
          <button class="btn-primary" @click="$emit('navigate', '/registro')">
      ...
      <section class="cta-section">
        <div class="cta-card">
          ...
          <button class="btn-primary large" @click="$emit('navigate', '/registro')">
      ...
      <div class="footer-content">
        ...
        <div class="footer-links">
          <div class="link-group">
            <h4>Plataforma</h4>
            <a href="#" @click.prevent="$emit('navigate', '/login')">Iniciar sesión</a>
            <a href="#" @click.prevent="$emit('navigate', '/registro')">Registrarse</a>
