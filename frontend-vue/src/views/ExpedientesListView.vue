  ...
  <main class="list">
    <header class="list__header">
      ...
      <div class="list__actions">
        ...
        <button type="button" class="list__primary" @click="$emit('navigate', '/expedientes/nuevo')">Nuevo expediente</button>
      </div>
    </header>
    ...
    <section class="list__table" aria-live="polite">
      ...
      <article v-for="item in filteredExpedientes" v-else :key="item.id" class="list__row">
        <div>
